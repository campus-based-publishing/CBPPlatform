...
class JournalSetupStep3Form extends JournalSetupForm {
	...
	function display($request, $dispatcher) {
		...
		// %CBP% Check whether of not required sections have been set
		$CBPPlatformDao =& DAORegistry::getDAO('CBPPlatformDAO');
		$templateMgr->assign_by_ref('collectionRequiredSections', $CBPPlatformDao->getRequiredSections($journal->getId()));
