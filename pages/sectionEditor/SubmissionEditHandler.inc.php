...
class SubmissionEditHandler extends SectionEditorHandler {
	...
	function submissionReview($args) {
		...
		$templateMgr->assign_by_ref('editorAttention', $CBPPlatformDao->getAuthorRequestEditorAttention($articleId)); //has an author requested editor attention?
		...
		if ($decisionMaker) $lastDecisionMaker = $decisionMaker->getFullName();
