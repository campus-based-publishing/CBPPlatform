...
<div id="breadcrumb">
	...
	<a href="{url page="article" op="view" path=$articleId|to_array:$galleyId}" class="current" target="_parent">{$article->getTitle('en_US')|escape} by {$article->getFirstAuthor()}</a>
</div>
