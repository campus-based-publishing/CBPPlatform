...
class TemplateManager extends PKPTemplateManager {
	...
	function TemplateManager($request = null) {
		...
		if (!defined('SESSION_DISABLE_INIT')) {
			...
			$this->assign('parentSiteTitle', $site->getLocalizedTitle()); //%LP% get the site title for the install
			...
			if (isset($journal)) {
				...
				//%LP% Atomistic / Collection imprint types
				$this->assign('atomistic', $journal->getSetting('atomistic'));
				$this->assign('collection', $journal->getSetting('collection'));
